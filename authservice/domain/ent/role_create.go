...
func (rc *RoleCreate) SetRoleName(rn role.RoleName) *RoleCreate {
	rc.mutation.SetRoleName(rn)
	return rc
}

// SetNillableRoleName sets the "roleName" field if the given value is not nil.
func (rc *RoleCreate) SetNillableRoleName(rn *role.RoleName) *RoleCreate {
	if rn != nil {
		rc.SetRoleName(*rn)
	}
	return rc
...
func (rc *RoleCreate) defaults() {
	if _, ok := rc.mutation.RoleName(); !ok {
		v := role.DefaultRoleName
		rc.mutation.SetRoleName(v)
	}
