...
func (rtc *RefreshTokenCreate) SetExpiredAt(s string) *RefreshTokenCreate {
	rtc.mutation.SetExpiredAt(s)
	return rtc
}

// SetRoleName sets the "roleName" field.
func (rtc *RefreshTokenCreate) SetRoleName(rn refreshtoken.RoleName) *RefreshTokenCreate {
	rtc.mutation.SetRoleName(rn)
	return rtc
}

// SetNillableRoleName sets the "roleName" field if the given value is not nil.
func (rtc *RefreshTokenCreate) SetNillableRoleName(rn *refreshtoken.RoleName) *RefreshTokenCreate {
	if rn != nil {
		rtc.SetRoleName(*rn)
	}
	return rtc
...
func (rtc *RefreshTokenCreate) defaults() {
	if _, ok := rtc.mutation.RoleName(); !ok {
		v := refreshtoken.DefaultRoleName
		rtc.mutation.SetRoleName(v)
	}
...
func (rtc *RefreshTokenCreate) check() error {
	...
	if _, ok := rtc.mutation.ExpiredAt(); !ok {
		return &ValidationError{Name: "expiredAt", err: errors.New(`ent: missing required field "RefreshToken.expiredAt"`)}
	}
	if _, ok := rtc.mutation.RoleName(); !ok {
		return &ValidationError{Name: "roleName", err: errors.New(`ent: missing required field "RefreshToken.roleName"`)}
	}
	if v, ok := rtc.mutation.RoleName(); ok {
...
func (rtc *RefreshTokenCreate) createSpec() (*RefreshToken, *sqlgraph.CreateSpec) {
	...
	if value, ok := rtc.mutation.RoleName(); ok {
